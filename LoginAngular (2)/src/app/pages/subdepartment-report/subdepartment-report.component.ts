...
@Component({
  selector: 'app-subdepartment-report',
  standalone: true,
  imports: [FormsModule, CommonModule, RouterModule],
  templateUrl: './subdepartment-report.component.html',
  styleUrl: './subdepartment-report.component.css'
})
export class SubdepartmentReportComponent implements OnInit {
  searchTerm: any;
